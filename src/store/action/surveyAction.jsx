import { apiBaseURL, surveyActionType, toastType } from "../../constants";
...
export const SurveyLists =
    ...
    async (dispatch) => {
        ...
        const admin = true;
        let url = apiBaseURL.FETCH_SURVEY_LIST;
        if (
            !_.isEmpty(filter) &&
            (filter.page ||
                filter.pageSize ||
        ...
        apiConfig
            ...
            .then((response) => {
                ...
                dispatch({
                    type: surveyActionType.FETCH_SURVEY_LIST,
