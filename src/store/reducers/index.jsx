...
import assignedGiftReducer from "./assignedGiftReducer";
import loadUnloadReducer from "./loadUnloadReducer";
import assignCustomerReducer from "./assignCustomerReducer";
import surveyReducer from "./surveyReducer";
import creditReducer from "./creditReducer";
import giftInventoryReducer from "./giftInventoryReducer";
import subAreaReducer from "./subAreaReducer";
...
export default combineReducers({
    ...
    users: userReducers,
    distributors:userReducers,
    warehouseusers:userReducers,
    ...
    gifts:giftReducer,
    giftHistory: giftReducer,
    cashlist:cashReducer,
    mileagelist:mileageReducer,
    mileageDetail:mileageReducer,
    chanels:chanelReducer,
    salesmans:salesmanReducer,
    salesmansAll:salesmanReducer,
    areas:areaReducer,
    coupons:couponReducer,
    assignedGifts:assignedGiftReducer,
    assignedProductsList:loadUnloadReducer,
    assignedCustomerList:assignCustomerReducer,
    surveys:surveyReducer,
    credits:creditReducer,
    countries:countryStateReducer,
    giftDetails:giftReducer,
    languageContents:languageReducer,
    languageContentsDetail:languageReducer,
    giftInventoryDetail:languageReducer,
    checkInDetails:surveyReducer,
    userNotifications:smsTemplatesReducer,
    adminNotifications:smsTemplatesReducer,
    adminNotificationsDetail:smsTemplatesReducer,
    subAreas:subAreaReducer,
    subAreasDetails:subAreaReducer,
    giftInventoryReport: languageReducer,
});
