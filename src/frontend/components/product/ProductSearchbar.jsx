...
const ProductSearchbar = (props) => {
    ...
    const filterProduct = posAllProducts
        .filter((qty) => qty.attributes.quantity > 0)
        .map((item) => ({
    ...
    const onProductSearch = (code) => {
        ...
        const singleProduct = posAllProducts
            ...
            .map((product) => product.attributes.quantity);
    ...
    return (
        <>        <Col className="position-relative my-3 search-bar col-xxl-10 col-lg-10 col-10">
          ...
          <Col className="col-xxl-2 col-lg-2 col-2">
            <Button className="btn  btn-lg success mx-12" onClick={backToLoadMainPage}>Back</Button>
          </Col>
        </>
