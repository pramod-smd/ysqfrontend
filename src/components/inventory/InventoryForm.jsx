...
import { updateProductInventoryQuantity } from "../../store/action/giftAction";
...
const InventoryForm = (props) => {
    ...
    const fetchProductInventories = async () => {
        try {
            ...
            const response = await axiosApi.get("product-inventory", {
                headers: {
            ...
            response?.data?.productInventories.forEach((item, index) => {
    ...
    const updateDistributorQuantity = async (distributorId) => {
        ...
        try {
            const response = await updateProductInventoryQuantity(payload);
    ...
    const updateWarehouseQuantity = async (warehouseId) => {
        ...
        await updateProductInventoryQuantity(payload);
    ...
    useEffect(() => {
        ...
        setIsDisabled(config && config.includes(Permissions.UPDATE_PRODUCT_INVENTORY_QAUNTITY)?false:true)
                                    ...
                                    <div className="card-body">
                                        ...
                                        <div className="d-flex justify-content-between">
                                            ...
                                            <div className="d-flex align-items-center">
                                                ...
                                                {config && config.includes(Permissions.UPDATE_PRODUCT_INVENTORY_QAUNTITY)?
                                                <button
                                                    onClick={async () => {
                                                        if (
                                                            selectedOption ===
                    ...
                    <div className="col-md-12">
                        <div className="card shadow-lg">
                            <div className="card-header bg-primary text-white">
                                <h4>{products?.name}</h4>
                                <h4>Product Inventory Update</h4>
                            </div>
                            <div className="card-body">
                                ...
                                <p className="card-text mb-4">
                                    Select either <strong>Distributor</strong>{" "}
                                    or <strong>Warehouse</strong> to update the
                                    inventory.
                                </p>
