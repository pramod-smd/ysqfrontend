...
const ProductsDetailsReport = (props) => {
    ...
    return (
        <MasterLayout>
            <TopProgressBar />
            <HeaderTitle title="Product Report Details" to='/app/report/report-products'/>
            <TabTitle title={placeholderText('stock.report.details.title')}/>
                ...
                <Tabs defaultActiveKey='sales' key={1} id='uncontrolled-tab-example' onSelect={(k) => setKey(k)}
                      className='mt-7 mb-5'>
                    ...
                    <Tab eventKey='sales-return' key={2} title={getFormattedMessage('sales-return.title')}
                         tabClassName='position-relative mb-3 me-7'>
                        <div className='w-100 mx-auto'>
...
export default connect(mapStateToProps, {stockDetailsWarehouseAction})(ProductsDetailsReport);
