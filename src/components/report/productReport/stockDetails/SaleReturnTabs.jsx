...
import { productDetailsSaleReturnAction } from "../../../../store/action/stockDetailsSaleReturnAction";
...
const SaleReturnTabs = (props) => {
    const {
        isLoading,
        totalRecord,
        productDetailsSaleReturnAction,
        frontSetting,
        fetchFrontSetting,
        warehouseValue,
    ...
    const onChange = (filter) => {
        productDetailsSaleReturnAction(id, filter, true);
    };
