...
const SuppliersReport = (props) => {
    ...
    const itemsValue =
        ...
        allCustomerReport.map((report) => ({
            ...
            phone: report.phone,
            chanel_name: report?.channel_details?.name,
            sub_area: report?.sub_area_details?.sub_area_name,
    ...
    const columns = [
        ...
        {
            name: "Subarea",
            selector: (row) => row?.sub_area,
            sortField: "sub_area_id",
            sortable: false,
        },
        {
            name: "total Order",
