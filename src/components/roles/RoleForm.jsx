                    ...
                    <div className='row'>
                        <div className='col-md-12'>
                            <Form.Group className='mb-5 form-group'>
                                ...
                                <Form.Control type='text' name='name' readOnly  placeholder={placeholderText("globally.input.name.placeholder.label")}
                                              className='form-control-solid'
                                              autoFocus={true}
                                              onChange={(event) => onChangeInput(event)}
                                              value={rolesValue?.display_name}/>
                                            ...
                                            return (
                                                <div className="col-md-4" key={index}>
                                                    <label
                                                        className='form-check form-check-custom form-check-solid form-check-inline d-flex align-items-center my-3 cursor-pointer custom-label'
                                                        key={index+1}>
                                                        <input type='checkbox' key={index} checked={permissions[index].selected}
                        ...
                        <div className='d-flex mt-5'>
                            {singleRole ?
                                ...
                                <div onClick={(event) => onSubmit(event, rolesValue)}>
                                    <input className='btn btn-primary me-3' type='submit' value={placeholderText("globally.save-btn")}
                                           disabled={!rolesValue.display_name || !(saveButtonEnable.length !== 0)}/>
                                </div>
                            }
                            <Link to='/app/roles'
