...
import { UpdateNotificationTemplate } from "../../store/action/notificationTemplateAction";

const NotificationTemplateForm = ( props ) => {
    const { id, singleSMSTemplate, UpdateNotificationTemplate } = props;
    ...
    const onSubmit = ( event ) => {
        ...
        if ( singleSMSTemplate && valid ) {
            if ( !disabled ) {
                UpdateNotificationTemplate( id, smsTemplateValue, navigate );
            }
        }
    };
                ...
                <Form>
                    <div className='row'>
                        ...
                        <ModelFooter onEditRecord={singleSMSTemplate} onSubmit={onSubmit} editDisabled={disabled}
                            link='/app/notification-templates' addDisabled={!smsTemplateValue.name} />
                    </div>
                </Form>
            </div>
        </div>
...
export default connect( null, { UpdateNotificationTemplate } )( NotificationTemplateForm );
