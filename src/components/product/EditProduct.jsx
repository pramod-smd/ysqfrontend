...
const EditProduct = (props) => {
    ...
    const mainProductItemsValue = singleProduct.length >= 1 && singleProduct.map(product => ({
        ...
        country_id: product?.attributes?.country_id,
        cn_name: subProduct?.cn_name,
        bn_name: subProduct?.bn_name,
        ...
        product_price:subProduct?.product_price,
        add_stock:subProduct?.add_stock,
        stock_alert:subProduct?.stock_alert,
        purchase_unit: getPurchaseUnit,
        quantity_limit: subProduct?.quantity_limit,
        notes: subProduct?.notes,
        cn_description: subProduct?.cn_description,
        bn_description: subProduct?.bn_description,
        ...
        isEdit: true,
        id: product.id,
        country_id: subProduct?.country_id,
    }));
