...

        {
            ...
            cell: (row) => (
                <ActionButton
                    ...
                    isEditMode={config && config.includes(Permissions.EDIT_PRODUCT)?true:false}
                    isDeleteMode={config && config.includes(Permissions.DELETE_PRODUCT)?true:false}
    ...
    return (
        <MasterLayout>
            ...
            <ReactDataTable
                ...
                onChange={onChange}
                isLoading={isLoading}
                ButtonValue={config && config.includes(Permissions.CREATE_PRODUCT)?getFormattedMessage("product.create.title"):""}
