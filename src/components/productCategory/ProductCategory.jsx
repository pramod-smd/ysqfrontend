        ...
        },
        {
            ...
            cell: row => <ActionButton 
              ...
              goToEditProduct={handleClose}
               isEditMode={config && config.includes(Permissions.EDIT_PRODUCT_CATEGORY)?true:false}
               isDeleteMode={config && config.includes(Permissions.DELETE_PRODUCT_CATEGORY)?true:false}                 
    ...
    return (
        <MasterLayout>
            ...
            <TabTitle title={placeholderText('product-categories.title')}/>
                <ReactDataTable 
                columns={columns} items={itemsValue} 
                onChange={onChange} isLoading={isLoading}
                AddButton={config && config.includes(Permissions.CREATE_PRODUCT_CATEGORY)?<CreateProductCategory/>:""}
...
const mapStateToProps = (state) => {
    const {productCategories, totalRecord, isLoading,allConfigData} = state;
    return {productCategories, totalRecord, isLoading,allConfigData}
};
