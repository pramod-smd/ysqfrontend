...
const UserForm = (props) => {
    ...
    const [userValue, setUserValue] = useState({
        ...
        password: "",
        confirm_password: "",
        role_id: 2, //singleUser ? singleUser[0].role_id : "",
    ...
    const disabled = selectImg
        ...
        : singleUser &&
          ...
          singleUser[0].role_id.label[0] === 2; // userValue.role_id.label[0];
    ...
    const handleValidation = () => {
        ...
        } else if (!/^[a-zA-Z0-9\s]+$/.test(userValue["first_name"])) {
            errorss["first_name"] =
        ...
        } else if (!/^[a-zA-Z0-9\s]+$/.test(userValue["last_name"])) {
            errorss["last_name"] =
        ...
        // Status validation
        else if (!userValue["status"]) {
            errorss["status"] = "Please select the status";
        } else {
            isValid = true;
        }
