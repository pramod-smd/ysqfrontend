...
const FilterDropdown = (props) => {
    ...
    const mileageTypeFilterOptions = getFormattedOptions(mileageTypeOptions);
    const collectionTypeFilterOptions = getFormattedOptions(
        collectionTypeOptions
    );
    ...
    const mileageTypeDefaultValue = mileageTypeFilterOptions.map((option) => {
        return {
            value: option.id,
            label: option.name,
        };
    ...
    const collectionTypeDefaultValue = collectionTypeFilterOptions.map((option) => {
        return {
            value: option.id,
            label: option.name,
        };
        ...
        >
            ...
            <Dropdown.Menu className="px-7 py-5">
                ...
                {isMileageType ? (
                    ...
                    >
                        <ReactSelect
                            multiLanguageOption={mileageTypeFilterOptions}
                            onChange={onPaymentTypeChange}
                            name="payment_type"
                            title={getFormattedMessage(
                                "select.mileage-type.label"
                            )}
                            value={
                                isReset
                                    ? mileageTypeDefaultValue[0]
                                    : mileageType
                            }
                            isRequired
                            defaultValue={mileageTypeDefaultValue[0]}
                            placeholder={getFormattedMessage(
                                "select.mileage-type.label"
                            )}
                        />
                ...
                {isCollectionType ? (
                    ...
                    >
                        <ReactSelect
                            multiLanguageOption={collectionTypeFilterOptions}
                            onChange={onPaymentTypeChange}
                            name="payment_type"
                            title="Collection Type"
                            value={
                                isReset
                                    ? collectionTypeDefaultValue[0]
                                    : collectionType
                            }
                            isRequired
                            defaultValue={collectionTypeDefaultValue[0]}
