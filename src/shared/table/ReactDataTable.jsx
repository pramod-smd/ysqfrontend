...
const ReactDataTable = (props) => {
    ...
    const onMileageTypeChange = (obj) => {
        dispatch({ type: "RESET_OPTION", payload: false });
        setMileageType(obj);
        dispatch({ type: "ON_TOGGLE", payload: false });
    };

    const onCollectionTypeChange = (obj) => {
        dispatch({ type: "RESET_OPTION", payload: false });
        setCollectionType(obj);
        dispatch({ type: "ON_TOGGLE", payload: false });
    };
    ...
    const onResetClick = () => {
        ...
        setMileageType({ label: 'All', value: '0' })
        setCollectionType({ label: 'All', value: '0' })
                ...
                >
                    {isShowFilterField ? (
                        <FilterDropdown
                            ...
                            onMileageTypeChange = {onMileageTypeChange}
    ...
    const onChangeDidMount = () => {
        const filters = {
            ...
            mileage_type:mileageType ?  mileageType.value : null,
